...
const MapHelper = {
    ...
    markers: null,
    userMarker: null,
    baseUrl: (document.querySelector('meta[name="app-base-url"]')?.content || '').replace(/\/$/, ''),
        ...
        masjids.forEach(m => {
            ...
            const popup = `
                <div class="map-popup">
                    ...
                    ${distText}
                    <a href="${this.baseUrl}/masjids/${m.id}" class="btn btn-sm btn-success mt-2 w-100">
                        View Details <i class="fas fa-arrow-right ms-1"></i>
                    </a>
                    <a href="${GPS.buildDirectionsUrl(m.latitude, m.longitude, userLat, userLng)}" target="_blank" class="btn btn-sm btn-outline-success mt-2 w-100" data-directions-link="true" data-dest-lat="${m.latitude}" data-dest-lng="${m.longitude}">
